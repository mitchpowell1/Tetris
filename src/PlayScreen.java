...
public class PlayScreen extends JPanel {
	...
	public PlayScreen(GameWindow w) {
		...
		setBorder(BorderFactory.createEtchedBorder(1, Color.LIGHT_GRAY,
				Color.DARK_GRAY));
		// setSize(400,600);
		setVisible(true);
	...
	/**
	 * Private inner class to listen for keyboard input and manipulate the game
	 * accordingly.
	 * 
	 * Listens for keys related to pausing the game, keys related to
	 * manipulating the game pieces and keys related to adjusting the parent
